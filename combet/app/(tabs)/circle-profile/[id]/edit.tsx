...
export default function EditCircle() {
  ...
  return (
    <GradientBackground style={{ paddingHorizontal: 20 }}>
      ...
      >
        <PageHeader title="Edit Circle" />

        <Text variant="labelLarge" style={{
          color: theme.colors.onSurfaceVariant, fontWeight: "600",
          letterSpacing: 1.5, marginBottom: 16, fontSize: 11, textAlign: "center",
        }}>
          CHANGE ICON
        </Text>
        ...
        <Text variant="labelLarge" style={{
          color: theme.colors.onSurfaceVariant, fontWeight: "600",
          letterSpacing: 1.5, marginBottom: 12, fontSize: 11, textAlign: "center", marginTop: 8,
        }}>
          PICK A COLOR
        </Text>
        ...
        <View style={{ marginTop: 28 }}>
          ...
          <View style={{
            ...
            borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14, marginBottom: 32,
            borderWidth: 1, backgroundColor: "rgba(255,255,255,0.07)", borderColor: "rgba(255,255,255,0.12)",
          }}>
