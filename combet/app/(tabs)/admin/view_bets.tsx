...
export default function AdminBetsScreen() {
  ...
  return (
    <GradientBackground style={{ paddingHorizontal: 20 }}>
      <PageHeader title="All Bets" subtitle={`${bets.length} total`} onBack={() => router.push("/(tabs)/profile")} />
          ...
          <Pressable onPress={(e) => e.stopPropagation()}>
            <View style={{
              ...
              <View style={{ alignItems: "center", marginBottom: 16 }}>
                ...
                <Text style={{ color: "#fff", fontSize: 17, fontWeight: "700", textAlign: "center" }}>Delete Bet</Text>
              ...
              <View style={{ flexDirection: "row", gap: 10, marginTop: 4 }}>
                ...
                <TouchableOpacity
                  onPress={deleteBet} disabled={deleting}
